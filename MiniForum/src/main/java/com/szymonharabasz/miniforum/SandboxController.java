...
public class SandboxController {
	...
	private static final String SQL_INSERT_USER = 
			"insert into users (username, password, info, joined) values (?, ?, ?, ?)";
	...
	String storeSomeUsersJdbc(Model model) {
		...
		try {
			...
			stmt.setString(3, "Quisque semper justo at risus. Donec venenatis, turpis vel "
			...
			stmt.setString(3, "vel tempus metus leo non est. Etiam sit amet lectus quis est "
